...
import {Database, IRecordState, PersonalDetailsTableBuilder, PersonRecord, RecordState} from "./Database/TableBuilder";
...
export default class PersonalDetails extends React.Component<IProps, IPersonState> {// 为属性和状态建立规范
    ...
    private userCanSave = (hasErrors: boolean) => {// 子组件执行，子组件改变父组件的canSave状态
